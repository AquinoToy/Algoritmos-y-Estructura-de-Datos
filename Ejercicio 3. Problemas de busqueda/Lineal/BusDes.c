/*
Implementacion del algorimto de Busqueda lineal en un conjunto desordenado
...
numeros desordenados y regresá el número de comparaciones necesarias para encontrar el
numero dado.

Compilacion:
Windows: gcc BusDes.c -o BusDes.exe
Linux/Mac: gcc BusDes.c -o BusDes

Ejecucion:
    ./BusDes {tamanio del arreglo a ordenar} {valor a buscar} < lista_de_numeros.txt
    ./BusDes {tamanio del arreglo a ordenar} {valor a buscar} < lista_de_numeros.txt > salida.txt
...
Descripcion: Funcion que retorna busca un valor en un conjunto de numeros desordenados y devuelve
