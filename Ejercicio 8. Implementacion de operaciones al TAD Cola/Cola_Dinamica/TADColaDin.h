...
int Search(cola *c, elemento e);  // Busca un elemento en la cola y retorna su posición.
void Flip(cola *c);				  // Invierte el orden de los elementos en la cola.
